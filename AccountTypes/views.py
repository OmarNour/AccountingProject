...
class AccountTypeUpdateView(LoginRequiredMixin, generic.UpdateView):
    ...
    def get_queryset(self):
        return AccountTypes.objects.filter(org_id_id=self.kwargs.get("org_id"))# implicity filters with pk givin from url
...
class DeleteAccountType(LoginRequiredMixin, generic.RedirectView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        try:
            ...
            account_type = AccountTypes.objects.filter(org_id=self.kwargs.get("org_id"),
