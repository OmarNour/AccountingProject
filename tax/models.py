...
class Tax(models.Model):
    org_id = models.ForeignKey(Organization, on_delete=models.CASCADE, related_name='Tax_org_id')
    ...
    tax_account = models.ForeignKey(ChartOfAccount, on_delete=models.CASCADE, null=False, blank=False, related_name='Tax_tax_account')
    total_tax_pct = models.DecimalField(null=False,blank=False, default=0, max_digits=10, decimal_places=4)

    created_by = models.ForeignKey(User, on_delete=models.CASCADE, default=User, related_name='Tax_created_by')
    created_date = models.DateTimeField(auto_now_add=True, editable=False)

    modified_by = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, related_name='Tax_modified_by')
...
class TaxComponents(models.Model):
    ...
    tax_id = models.ForeignKey(Tax, on_delete=models.CASCADE, null=False, blank=False, related_name='TaxComponents_tax')
    ...
    created_by = models.ForeignKey(User, on_delete=models.CASCADE, default=User, related_name='TaxComponents_created_by')
    created_date = models.DateTimeField(auto_now_add=True, editable=False)

    modified_by = models.ForeignKey(User, on_delete=models.CASCADE, null=True, blank=True, related_name='TaxComponents_modified_by')
