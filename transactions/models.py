...
class Transaction(models.Model):
    ...
    dr_account_code = models.ForeignKey(ChartOfAccount, null=True, blank=False, related_name='Transactions_dr_account_code', on_delete=models.PROTECT)
    cr_account_code = models.ForeignKey(ChartOfAccount, null=True, blank=False, related_name='Transactions_cr_account_code', on_delete=models.PROTECT)
